...
const checkSeatsAvailability = async (
  ...
  const takenSeats = selectedSeats.filter(
    (seat) => Boolean(occupiedSeats[seat])
  );

  if (takenSeats.length > 0) {
    return {
      available: false,
      reason: `Seats already booked: ${takenSeats.join(", ")}`,
    };
  }
...
export const createBooking = async (
  ...
  try {
    ...
    //
    // Stripe requires expires_at to be
    // at least 30 minutes from creation.
    // ==================================================
    ...
    // ==================================================
    // 13. SCHEDULE PAYMENT CHECK
    //
    // Inngest receives this event,
    // waits 30 minutes,
    // then checks booking.isPaid.
    // ==================================================
    ...
    // ROLLBACK
    //
    // If something fails after the booking
    // was created:
    //
    // 1. Release seats
    // 2. Delete booking
