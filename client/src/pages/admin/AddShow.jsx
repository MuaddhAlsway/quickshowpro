...
const handleRemoveTime = (date, time) => {
  setDateTimeSelection((prev) => {
    ...
    // If no times remain for this date,
    // remove the entire date property
    ...
    <>
      ...
      <div className="mt-8">
        ...
        <div className="inline-flex items-center gap-2 border border-gray-600 px-3 py-2 rounded-md">
          ...
          <input type="number" min={0} className="outline-none" placeholder="Enter show price" onChange={(e) => setShowPrice(e.target.value)} />
        </div>
